...
const int level1 = 128; //50%
const int level2 = 204; //80% 
const int level3 = 255; //100%
...
void setup() {
  ...
  xTaskCreatePinnedToCore(
      Task1code, //funksjonen som implementerer oppgaven
  ...
  xTaskCreatePinnedToCore(
      Task2code, //funksjonen som implementerer oppgaven 
...
//Switchcase for vifte modus 
  ...
  if(temp >= tempLevel3 && nowMillis - previousMillisLuftevindu >= lufteVinduTid && trykkTellerVifte == 2) {       
